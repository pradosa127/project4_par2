  ...
  _createClass(App, null, [{
    ...
    value: function init() {
      ...
      for (var i = 0; i < nUsers; i++) {
        ...
        socketArr[i].onOpen(function (ev) {
          return console.log("OPEN", ev);
        });
        socketArr[i].onError(function (ev) {
          return console.log("ERROR", ev);
        });
        socketArr[i].onClose(function (e) {
        ...
        chan[i].join().receive("ignore", function () {
        ...
        chan[i].onError(function (e) {
          return console.log("something went wrong", e);
        });
        chan[i].onClose(function (e) {
        ...
        chan[i].on("new:msg", function (msg) {
          console.log("#################" + msg.user);
          $messages.append(_this.messageTemplate(msg));
          scrollTo(0, document.body.scrollHeight);
        });

        chan[i].on("user:entered", function (msg) {
